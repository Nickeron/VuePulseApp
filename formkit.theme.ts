...
/**
  ...
  *
  * @checksum - d367ef989f05315511dd3dc138253d914484b572de3d0aa4d456a131f509d7f3
  * @variables - radius=rounded-xl,accentColor=amber,colorTemperature=stone,spacing=2,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded-full,swatchRadius=rounded-full
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-amber-500": true,
    "peer-checked:border-amber-600": true,
    "relative": true,
    "block": true,
    "text-lg": true,
    "w-[1em]": true,
    ...
    "peer-checked:bg-amber-50": true,
    "peer-checked:text-amber-600": true,
    ...
    "dark:peer-checked:bg-amber-900": true,
    "dark:peer-checked:text-amber-400": true
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-amber-500": true,
    "focus-within:!border-amber-500": true,
  ...
  "family:dropdown__listitem": {
    ...
    "text-stone-700": true,
    "text-base": true,
    "data-[is-active]:bg-amber-100": true,
    ...
    "data-[is-active]:before:ring-amber-500": true,
    "data-[is-active]:before:ring-inset": true,
    "data-[is-active]:before:ring-offset-amber-100": true,
  ...
  "family:dropdown__loadMoreInner": {
    ...
    "cursor-pointer": true,
    "dark:text-stone-200": true,
    "dark:hover:text-amber-500": true
  },
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-amber-500": true
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-amber-400": true,
  ...
  "family:dropdown__emptyMessage": {
    ...
    "aria-selected:bg-amber-600": true
  },
  "button__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
    ...
    "dark:text-amber-500": true,
    "dark:bg-transparent": true,
    "dark:hover:bg-amber-50/5": true
  },
  "checkbox__decorator": {
    "rounded": true
  },
  ...
  "date__input": {
    ...
    "selection:text-stone-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-day-field]:bg-amber-100": true,
    "focus:[&::-webkit-datetime-edit-month-field]:bg-amber-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-amber-100": true
  },
  "datetime-local__input": {
    ...
    "focus:[&::-webkit-datetime-edit-month-field]:bg-amber-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-amber-100": true,
    "focus:[&::-webkit-datetime-edit-hour-field]:bg-amber-100": true,
    "focus:[&::-webkit-datetime-edit-minute-field]:bg-amber-100": true,
    "focus:[&::-webkit-datetime-edit-ampm-field]:bg-amber-100": true
  },
  "file__fileList": {
    "group/list": true,
    "peer": true,
  ...
  "file__fileRemove": {
    ...
    "peer-data-[has-multiple]:text-amber-600": true,
  ...
  "form__messageLink": {
    ...
    "group-[]/summary:ring-amber-600": true
  },
  "month__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "range__input": {
    ...
    "[&::-webkit-slider-thumb]:bg-amber-600": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-amber-500": true,
    ...
    "[&::-moz-range-thumb]:bg-amber-600": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-amber-500": true,
  ...
  "select__option": {
    ...
    "group-data-[multiple]:checked:bg-amber-100": true,
    "group-data-[multiple]:focus:bg-amber-100": true,
    ...
    "dark:bg-stone-800": true,
    "dark:text-stone-300": true,
    "dark:group-data-[multiple]:focus:bg-amber-800": true,
    "dark:group-data-[multiple]:checked:bg-amber-800": true
  },
  "select__prefixIcon": {
    "flex": true,
    "items-center": true,
  ...
  "submit__input": {
    ...
    "bg-amber-600": true,
    "!text-white": true,
    "active:text-amber-100": true,
    "active:bg-amber-700": true,
  ...
  "week__input": {
    ...
    "selection:text-stone-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-week-field]:bg-amber-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-amber-100": true
  },
  ...
  "colorpicker__control": {
    ...
    "focus-visible:ring-amber-500": true
  },
  ...
  "colorpicker__fieldGroup": {
    ...
    "[&>input]:selection:bg-amber-100": true,
    "[&>input]:m-0": true,
    "[&>input]:grow": true,
    "[&>input]:shrink": true,
    "[&>input]:w-full": true,
    ...
    "[&>input:focus]:ring-amber-600": true,
    "[&>input:focus]:border-amber-600": true,
  ...
  "colorpicker__swatch": {
    ...
    "[&>canvas:focus-visible]:ring-amber-500": true,
  ...
  "datepicker__dayCell": {
    ...
    "dark:bg-stone-600": true,
    "dark:text-stone-300": true,
    "dark:aria-selected:bg-amber-600": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-amber-600": true,
  ...
  "datepicker__timeInput": {
    ...
    "p-1.5": true,
    "my-2.5": true,
    "focus-visible:outline-amber-600": true,
    "dark:text-stone-300": true,
    "dark:bg-transparent": true,
    "dark:border-stone-600": true
  },
  ...
  "datepicker__dayButton": {
    ...
    "dark:text-stone-300": true,
    "dark:border-stone-600": true,
    "dark:hover:border-amber-500": true
  },
  ...
  "datepicker__calendarIcon": {
    "text-stone-600": true,
    "focus-visible:text-amber-600": true,
    "flex": true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  "rating__ratingItem": {
    ...
    "focus-within:outline-amber-600": true,
    "w-[1.5em]": true,
    "h-[1.5em]": true
  },
  ...
  "toggle__track": {
    ...
    "transition-all": true,
    "bg-stone-400": true,
    "peer-checked:bg-amber-600": true,
    ...
    "shadow": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-amber-500": true,
  ...
  "togglebuttons__input": {
    ...
    "dark:disabled:text-amber-500": true,
    "dark:text-amber-500": true,
    "aria-[pressed=true]:bg-amber-600": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-amber-600": true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-amber-500": true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-amber-600": true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-amber-600": true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-amber-600": true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-amber-600": true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-amber-600": true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-amber-500": true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-amber-600": true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-amber-600": true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-amber-600": true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-amber-600": true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-amber-600": true
  },
  "transferlist__outer": {
    "group": true,
    "min-w-0": true,
    ...
    "text-base": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-amber-600": true,
  ...
  "transferlist__transferlist": {
    ...
    "[&:has(:focus-visible)]:ring-amber-500": true,
    "dark:border-stone-600": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "ring-1": true,
    "ring-stone-200": true,
    "aria-selected:bg-amber-100": true,
    "data-[is-active=true]:bg-amber-100": true,
    "data-[is-active=true]:ring-amber-200": true,
    "aria-selected:ring-amber-200": true,
    "relative": true,
    "flex": true,
    "cursor-pointer": true,
    "items-center": true,
    ...
    "dark:bg-stone-800": true,
    "dark:text-stone-300": true,
    "dark:data-[is-active=true]:bg-amber-900": true,
    "dark:aria-selected:bg-amber-900": true,
    "dark:ring-stone-700": true,
    "dark:data-[is-active=true]:ring-amber-600": true,
    "dark:aria-selected:ring-amber-600": true,
    "[&.formkit-dropZone]:bg-amber-100": true,
    "[&.formkit-selectionDropZone]:bg-amber-100": true,
    "[&.formkit-touchDropZone]:bg-amber-100": true,
    "[&.formkit-touchSelectionDropZone]:bg-amber-100": true,
    "[&.formkit-longTouch]:bg-amber-100": true,
    "dark:[&.formkit-dropZone]:bg-amber-900": true,
    "dark:[&.formkit-selectionDropZone]:bg-amber-900": true,
    "dark:[&.formkit-touchDropZone]:bg-amber-900": true,
    "dark:[&.formkit-touchSelectionDropZone]:bg-amber-900": true,
    "dark:[&.formkit-longTouch]:bg-amber-900": true
  },
  ...
  "transferlist__transferlistSearch": {
    ...
    "dark:border-stone-600": true,
    "dark:text-stone-300": true,
    "dark:selection:bg-amber-100": true,
    "dark:selection:text-stone-700": true,
    "dark:bg-stone-800": true
  },
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-amber-600": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-amber-600": true
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=true]/tab:bg-amber-600": true,
